...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0001_budget_category_recurringtransaction_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('superadmin', 'Super Admin'), ('data_entry', 'Data Entry'), ('deputy_director', 'Deputy Director'), ('executive_director', 'Executive Director'), ('chief_executive', 'Chief Executive'), ('regular_user', 'Regular User')], default='regular_user', max_length=20)),
